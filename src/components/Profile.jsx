  ...
  return (
    <div className="flex flex-col gap-8 font-Monserrat md:w-2/3 md:pb-20 ">
      ...
      <div className="flex gap-8">
        <button className="rounded-full  border-solid border-2 border-zinc-900 text-zinc-900 dark:border-stone-200 dark:text-stone-200 font-semibold  py-1 px-12 hover:bg-stone-100 dark:hover:bg-zinc-800">
          CV
        </button>
        <button className="rounded-full   text-zinc-900 dark:bg-lime-300 bg-lime-500 font-semibold  py-1 px-10 hover:bg-lime-400 dark:hover:bg-lime-100">
          LinkedIn
        </button>
      </div>
    </div>
